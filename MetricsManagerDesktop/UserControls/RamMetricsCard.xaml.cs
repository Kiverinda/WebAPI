...
{
    public sealed partial class RamMetricsCard : UserControl, INotifyPropertyChanged, IRamMetricsCard
    {
        private IRamMetricsCardViewModel _viewModel;
        
        public RamMetricsCard(IRamMetricsCardViewModel viewModel)
        {
            InitializeComponent();
